...
// respectfully: the above line is unfortunate, as it prevents the creation of multiple Instapush objects

module.exports = Instapush;

/* to be backwards compatible with 1.0.1, callers should use:

   var instapush = require('instapush');
   if (typeof instapush === 'function') instapush = new instapush();
